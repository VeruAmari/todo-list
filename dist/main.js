...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fetchExistingData: () => (/* binding */ fetchExistingData),
...
/* harmony import */ var _projectObj__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projectObj */ "./src/projectObj.js");
/* harmony import */ var _todoObj__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todoObj */ "./src/todoObj.js");
/* harmony import */ var _checklistObj__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checklistObj */ "./src/checklistObj.js");
/* harmony import */ var _uiProject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./uiProject */ "./src/uiProject.js");
/* harmony import */ var _uiCheckLI__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./uiCheckLI */ "./src/uiCheckLI.js");
/* harmony import */ var _uiTodo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./uiTodo */ "./src/uiTodo.js");
/* harmony import */ var _uiForms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./uiForms */ "./src/uiForms.js");
/* harmony import */ var _dbHandler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dbHandler */ "./src/dbHandler.js");
...
function updateDataOnClick(type, data, ui, attribute) {
  ...
  if (newData) {
    ...
    (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().modifyData(type, data.getID(), attribute, data.getTitle());
  }
}
...
function updateDescriptionOnClick(type, data, ui, attribute) {
  ...
  if (newData) {
    ...
    (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().modifyData(type, data.getID(), attribute, data.getDescription());
  }
}
function updateDueOnClick(type, data, ui, attribute) {
  ...
  if (newData) {
    ...
    (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().modifyData(type, data.getID(), attribute, data.getDue());
  }
}
function updatePriorityOnClick(type, data, ui, attribute) {
  ...
  if (newData) {
    ...
    (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().modifyData(type, data.getID(), attribute, data.getPriority());
  }
}
function updateNotesOnClick(type, data, ui, attribute) {
  ...
  if (newData) {
    ...
    (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().modifyData(type, data.getID(), attribute, data.getNotes());
  }
}
...
function makeNewCheckLI(...arglist) {
  ...
  const checkLIData = new _checklistObj__WEBPACK_IMPORTED_MODULE_2__["default"](...arglist);

  const checkLIUI = new _uiCheckLI__WEBPACK_IMPORTED_MODULE_4__["default"](
    checkLIData.getID(),
  ...
  //
  (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().newChecklistItem(
    checkLIData.getID(),
    checkLIData.getTitle(),
  ...
  (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().modifyData(
    "todo",
    checkLIData.getTodoID(),
    "checklistIDs",
    checkLIData.getID(),
  ...
  function cLIDelete() {
    if (confirm(`Delete Checklist Item "${  checkLIData.getTitle()  }"?`)) {
      (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().removeData("checklistitem", checkLIData.getID());
...
function makeNewTodo(...arglist) {
  ...
  const todoData = new _todoObj__WEBPACK_IMPORTED_MODULE_1__["default"](...arglist);

  // Once sanitized, they are added to the document.
  //
  const todoUI = new _uiTodo__WEBPACK_IMPORTED_MODULE_5__["default"](
    todoData.getID(),
    todoData.getTitle(),
  ...
  const form = (0,_uiForms__WEBPACK_IMPORTED_MODULE_6__["default"])().checklistItemForm();
  form.addEventListener("submit", handleC);
  todoUI.appendChecklist(form);

  // Add Todo to database
  //
  (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().newTodo(
    todoData.getID(),
    todoData.getTitle(),
    todoData.getDescription(),
    todoData.getDue(),
  ...
  function todoDelete() {
    if (confirm(`Delete Todo "${  todoData.getTitle()  }"?`)) {
      ...
      (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])()
        .getData("todo", todoID)
        .checklistIDs.forEach((cLIID) => {
          (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().removeData("checklistitem", cLIID);
        });

      (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().removeData("todo", todoID);
...
function makeNewProject(...arglist) {
  ...
  const projectData = new _projectObj__WEBPACK_IMPORTED_MODULE_0__["default"](...arglist);
  // Add sanitized data to UI
  const projectUI = new _uiProject__WEBPACK_IMPORTED_MODULE_3__["default"](
    projectData.getID(),
    projectData.getTitle(),
    projectData.getStatus(),
  );

  (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().newProject(
    projectData.getID(),
    projectData.getTitle(),
  ...
  const form = (0,_uiForms__WEBPACK_IMPORTED_MODULE_6__["default"])().todoForm();
  ...
  function deleteProject() {
    if (confirm(`Delete Project "${  projectData.getTitle()  }"?`)) {
      ...
      (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().removeData("project", projectData.getID());
...
function testFunction() {
  ...
  const todo1 = makeNewTodo(
    ...
    (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(3045, 1, 10), "dd/MM/yyyy"),
    5,
...
function fetchExistingData() {
  const projects = (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().getProjects();
  ...
  projects.forEach((projectID) => {
    ...
    const data = (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().getData("project", projectID);
    ...
    (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])()
      ...
      .todolistIDs.forEach((todoID) => {
        const tododata = (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().getData("todo", todoID);
        ...
        (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])()
          ...
          .checklistIDs.forEach((checkLIID) => {
            const checklidata = (0,_dbHandler__WEBPACK_IMPORTED_MODULE_7__["default"])().getData("checklistitem", checkLIID);
...
function initialRender() {
  const form = (0,_uiForms__WEBPACK_IMPORTED_MODULE_6__["default"])().projectForm();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UIBasics)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UIChecklistItem)
/* harmony export */ });
/* harmony import */ var _uiBasics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./uiBasics */ "./src/uiBasics.js");
/* eslint no-console: "off", no-underscore-dangle: "off" */


class UIChecklistItem extends _uiBasics__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #container;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UIProject)
/* harmony export */ });
/* harmony import */ var _uiBasics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./uiBasics */ "./src/uiBasics.js");
/* eslint-disable no-console */
/* eslint-disable no-underscore-dangle */
...
class UIProject extends _uiBasics__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #todosContainer;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UITodo)
/* harmony export */ });
/* harmony import */ var _uiBasics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./uiBasics */ "./src/uiBasics.js");
/* eslint-disable no-console */
/* eslint-disable no-underscore-dangle */
...
class UITodo extends _uiBasics__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #titleContainer;
