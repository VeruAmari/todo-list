...
.project.title.container {
  ...
  height: fit-content;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,iBAAiB;EACjB,wBAAwB;EACxB,yBAAyB;AAC3B;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,iCAAiC;EACjC,0BAA0B;EAC1B,gBAAgB;EAChB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,uBAAuB;EACvB,0DAA0D;EAC1D,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,wBAAwB;EACxB,gCAAgC;EAChC,cAAc;;AAEhB;AACA;;EAEE,aAAa;EACb,kBAAkB;AACpB;AACA;EACE,aAAa;EACb,gCAAgC;EAChC,aAAa;AACf;AACA;EACE,aAAa;EACb,gCAAgC;EAChC,cAAc;AAChB;AACA;;;EAGE,WAAW;AACb;AACA;EACE,gBAAgB;EAChB,aAAa;EACb,mBAAmB;EACnB,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,oCAAoC;EACpC,mBAAmB;AACrB","sourcesContent":[":root {\n  /* Variables */\n  --color-1: tomato;\n  --color-2: lightseagreen;\n  --color-3: cornflowerblue;\n}\n\n* {\n  padding: 0px;\n  margin: 0px;\n  box-sizing: border-box;\n}\n\nbody {\n  display: grid;\n  grid-template-rows: auto 1fr auto;\n  grid-template-columns: 1fr;\n  min-width: 100vw;\n  min-height: 100vh;\n}\n.inner-container {\n  display: grid;\n  grid-template-rows: 50%;\n  grid-template-columns: repeat(auto-fit, minmax(270px,1fr));\n  overflow-y: scroll;\n}\n\n.project-container {\n  display: grid;\n  grid-template-rows: 2rem;\n  border: solid 1px var(--color-1);\n  padding: .5rem;\n\n}\n.todos.container,\n.todo.checklist {\n  display: grid;\n  overflow-y: scroll;\n}\n.todo-container {\n  display: grid;\n  border: solid 1px var(--color-2);\n  padding: 1rem;\n}\n.checklist-item-container {\n  display: grid;\n  border: solid 1px var(--color-3);\n  padding: .5rem;\n}\n.todo-container.form,\n.checklist-item-container.form,\n.project-container.form {\n  order: 9999;\n}\nfooter, header{\n  min-height: 3rem;\n  display: grid;\n  align-items: center;\n  justify-content: center;\n}\n.project.title.container {\n  display: grid;\n  grid-template-columns: auto 1fr auto;\n  height: fit-content;\n}"],"sourceRoot":""}]);
// Exports
...
function updateDataOnClick ( type, data, ui, attribute ) {
    ...
    if (newData) {
        ...
        (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().modifyData(
            type,
            data.getID(),
            attribute,
            data.getTitle()
...
function makeNewProject(...arglist) {
    ...
    function deleteProject(event){
        ...
        if (confirm('Delete Project "' + projectData.getTitle() + '"?')){
            ...
            (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getData("project", projectData.getID())["todolistIDs"].forEach((todoID)=>{
                // Delete checklistitems from database
                (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getData("todo", todoID)["checklistIDs"].forEach((cLIID)=>{
                    (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().removeData("checklistitem", cLIID);
                });

                (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().removeData("todo", todoID);
            });
            // Delete Project from database
            (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().removeData("project", projectData.getID());
...
function makeNewCheckLI(...arglist) {
    ...
    function cLIDelete(){
        if (confirm('Delete Checklist Item "' + checkLIData.getTitle() + '"?')){
            (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().removeData("checklistitem", checkLIData.getID());
