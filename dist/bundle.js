...
.project-container.form {
  order: 9999;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,iBAAiB;EACjB,wBAAwB;EACxB,yBAAyB;AAC3B;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,sBAAsB;AACxB;;AAEA;EACE,YAAY;EACZ,aAAa;AACf;AACA;EACE,aAAa;EACb,2BAA2B;EAC3B,0DAA0D;AAC5D;;AAEA;EACE,aAAa;EACb,gCAAgC;EAChC,aAAa;AACf;AACA;;EAEE,aAAa;AACf;AACA;EACE,aAAa;EACb,gCAAgC;EAChC,aAAa;AACf;AACA;EACE,aAAa;EACb,gCAAgC;EAChC,cAAc;AAChB;AACA;;;EAGE,WAAW;AACb","sourcesContent":[":root {\n  /* Variables */\n  --color-1: tomato;\n  --color-2: lightseagreen;\n  --color-3: cornflowerblue;\n}\n\n* {\n  padding: 0px;\n  margin: 0px;\n  box-sizing: border-box;\n}\n\nbody {\n  width: 100vw;\n  height: 100vh;\n}\n.inner-container {\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n  grid-template-columns: repeat(auto-fit, minmax(265px,1fr));\n}\n\n.project-container {\n  display: grid;\n  border: solid 1px var(--color-1);\n  padding: 1rem;\n}\n.todos.container,\n.todo.checklist {\n  display: grid;\n}\n.todo-container {\n  display: grid;\n  border: solid 1px var(--color-2);\n  padding: 1rem;\n}\n.checklist-item-container {\n  display: grid;\n  border: solid 1px var(--color-3);\n  padding: .5rem;\n}\n.todo-container.form,\n.checklist-item-container.form,\n.project-container.form {\n  order: 9999;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   makeNewCheckLI: () => (/* binding */ makeNewCheckLI),
...
/* harmony export */ });
/* harmony import */ var _projectObj_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./projectObj.js */ "./src/projectObj.js");
/* harmony import */ var _todoObj_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todoObj.js */ "./src/todoObj.js");
/* harmony import */ var _checklistObj_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checklistObj.js */ "./src/checklistObj.js");
/* harmony import */ var _ui_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ui.js */ "./src/ui.js");
/* harmony import */ var _dbHandler_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dbHandler.js */ "./src/dbHandler.js");
...
function fetchExistingData() {
    let projects = (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getProjects();
    ...
    projects.forEach((projectID)=> {
        ...
        const data = (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getData("project", projectID);
        ...
        (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getData("project", projectID)["todolistIDs"].forEach((todoID)=>{

            const tododata = (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getData("todo", todoID);
            ...
            (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getData("todo", todoID)["checklistIDs"].forEach((checkLIID)=>{
            
                const checklidata = (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().getData("checklistitem", checkLIID);
...
function initialRender(){
    const form = (0,_ui_js__WEBPACK_IMPORTED_MODULE_3__.formCreator)().projectForm();
...
function makeNewProject(...arglist) {
    ...
    const projectData = new _projectObj_js__WEBPACK_IMPORTED_MODULE_0__.Project(...arglist);
    // Add sanitized data to UI
    const projectUI = new _ui_js__WEBPACK_IMPORTED_MODULE_3__.UIProject(
        projectData.getID(),
        projectData.getTitle(),
        projectData.getStatus()
    );

    (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().newProject(
        projectData.getID(),
        projectData.getTitle(),
    ...
    const form = (0,_ui_js__WEBPACK_IMPORTED_MODULE_3__.formCreator)().todoForm()
    ...
    function toggleAll() {
        ...
        (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().modifyData("project",projectData.getID(), "status", projectData.getStatus());
    };
...
function makeNewTodo(...arglist) {
    ...
    const todoData = new _todoObj_js__WEBPACK_IMPORTED_MODULE_1__.Todo(...arglist);

    // Once sanitized, they are added to the document.
    //
    const todoUI = new _ui_js__WEBPACK_IMPORTED_MODULE_3__.UITodo(
        todoData.getID(),
        todoData.getTitle(),
    ...
    const form = (0,_ui_js__WEBPACK_IMPORTED_MODULE_3__.formCreator)().checklistItemForm()
    form.addEventListener("submit", handleC);
    todoUI.appendChecklist(form);

    // Add Todo to database
    //
    (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().newTodo(
        todoData.getID(),
        todoData.getTitle(),
        todoData.getDescription(),
        todoData.getDue(),
    ...
    (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().modifyData("project",todoData.getProjectId(),"todolistIDs", todoData.getID());
    ...
    function toggleAll() {
        ...
        (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().modifyData("todo",todoData.getID(), "status", todoData.getStatus());
    };
...
function makeNewCheckLI(...arglist) {
    ...
    const checkLIData = new _checklistObj_js__WEBPACK_IMPORTED_MODULE_2__.ChecklistItem(...arglist);

    const checkLIUI = new _ui_js__WEBPACK_IMPORTED_MODULE_3__.UIChecklistItem(
        checkLIData.getID(),
    ...
    //
    (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().newChecklistItem(
        checkLIData.getID(),
        checkLIData.getTitle(),
    ...
    (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().modifyData("todo",checkLIData.getTodoID(),"checklistIDs", checkLIData.getID());
    ...
    function toggleAll() {
        ...
        (0,_dbHandler_js__WEBPACK_IMPORTED_MODULE_4__.database)().modifyData("checklistitem", checkLIData.getID(), "status", checkLIData.getStatus());
    };
...
function testFunction() {
    ...
    const todo1 = makeNewTodo(
        ...
        (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])( new Date(3045,1,10), 'dd/MM/yyyy'),
        5,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   UIChecklistItem: () => (/* binding */ UIChecklistItem),
/* harmony export */   UIProject: () => (/* binding */ UIProject),
/* harmony export */   UITodo: () => (/* binding */ UITodo),
...
class UIProject extends UIBasics {
    #todosContainer;
    #container;
...
class UIChecklistItem extends UIBasics {
    #container
    constructor (id, title, status) {
        super(id, status);
        // Public attributes //
